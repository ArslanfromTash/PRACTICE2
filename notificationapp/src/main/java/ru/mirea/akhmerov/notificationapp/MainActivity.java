package ru.mirea.akhmerov.notificationapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String CHANELL_ID = "com.mirea.asd.notification.ANDROID";
    ...
    public void onClickNewMessageNotification(View view){
        ...
        if (Build.VERSION.SDK_INT>=Build.VERSION_CODES.O){
            NotificationChannel notificationChannel = new NotificationChannel(CHANELL_ID,
